...
COKLAT = ('\x1b[1;33m')
# Banner
banner = (f"""     {MERAH}({PUTIH}★ CONVERT COOKIE KE TOKEN FACEBOOK★{MERAH}){PUTIH}
{MERAH}╭╮▒╱▔▔▔▔╲▒╭╮ ╰╲╲▏▂╲╱▂▕╱╱╯
{PUTIH} ▒▒▒▏▇▏▕▇▕▒▒▒ ▒▒▒╲▔▕▍▔╱▒▒▒ ╭╱╱▒╋╋╋╋▒╲╲╮
{MERAH} ╰╯╯▒╲▂▂╱▒╰╰╯

{BIRU} ←[̲̅S̲̅][̲̅E̲̅][̲̅M̲̅][̲̅O̲̅][̲̅G̲̅][̲̅A̲̅] [̲̅B̲̅][̲̅E̲̅][̲̅R̲̅][̲̅M̲̅][̲̅A̲̅][̲̅N̲̅][̲̅F̲̅][̲̅A̲̅][̲̅A̲̅][̲̅T̲̅]→
...
{COKLAT}──────────────────────
   """)
    ...
    if masuk == '1' or masuk == '01':
      ...
      print(f"{KUNING}.+.{PUTIH} no file ");time.sleep(3);os.system('xnxx.com');exit()
